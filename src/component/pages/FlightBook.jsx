                  ...
                  <div className={booksty.log_book}>
                    ...
                    <div className={booksty.log_adress}>
                      ...
                      <div className={booksty.log_signbtn}>
                        <Link
                          to={`/flydetailsthree/${cardData.id}?type=${type}`}
                          style={{
                            textDecoration: "none",
                            color: "inherit",
                            width: "100%",
                        ...
                        <div className={booksty.log_book}>
                          ...
                          <div className={booksty.log_adress}>
                            ...
                            <p>
                              ...
                              Standard message and data rates apply. Privacy
                              Policy
                            </p>
                            <div className={booksty.log_signbtn}>
                              <Comonbtn
                                addbtn={booksty.cont}
                                toggleSection={handleClicktwo}
                              >
                                Continue
                              </Comonbtn>
                            </div>
          ...
          {showModal && (
            <div className={modalsty.modal_overlay}>
              <div className={modalsty.modal_content}>
                ...
                <Comonbtn
                  addbtn={`${modalsty.mybtn} ${modalsty.c_anim_btn}`}
                  toggleSection={handleClickthre}
                >
