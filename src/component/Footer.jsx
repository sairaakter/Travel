...
import fotsty from "../style/Footer.module.css";
export default function Footer() {
  return (
    <section className={fotsty.footer}>
      <div className="">
        <div className="container cus_container">
          <div className={fotsty.toppop}>
            <div className={`row ${fotsty.tofoter}`}>
              <div className="col-lg-7">
                <div className={fotsty.tof_left}>
                  <h1>
                    Subscribe
                    <br />
                    Newsletter
                  ...
                  <div className={fotsty.emal_adress}>
                    <input
                      type="text"
                      id="emal"
                      className={fotsty.emal}
                      placeholder="Your email address"
                    />
                    <div
                      className={`${fotsty.emalbtn} ${fotsty.comon_allbtnstwo}`}
                    >
                      <button type="button" className={fotsty.comonbtn}>
                        Subscribe
                      </button>
                    </div>
                  </div>
              ...
              <div className="col-lg-5">
                <div className={fotsty.tof_right}>
                  <img src={tofrgt} />
                </div>
              </div>
            </div>
      ...
      <footer className="">
        <div className="container cus_container">
          <div className={`row ${fotsty.f_middle}`}>
            <div
              className={`col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-sm-4 col-6 ${fotsty.exclusiv}`}
            >
              <div className={fotsty.footer_logo}>
                <img src={footerlogo} alt="golobe" />
                <div className={fotsty.footer_sblogo}>
                  <a href="#">
                    <svg
                      width="18"
                      height="18"
