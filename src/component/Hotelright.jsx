...
import Hoteinfotwo from "./Hotelinfotwo";

export default function Hotelright({ filtersty }) {
  ...
  useEffect(() => {
    localStorage.setItem("cards", JSON.stringify(filtedata));
  }, []);
  const visibleData = showAll ? filtedata : filtedata.slice(0, 4);
      ...
      <div className={filtersty.fil_right}>
        ...
        <div className={filtersty.recomended}>
          <p>
            ...
            <span style={{ color: "#FF8682" }}>{filtedata.length} places</span>
          </p>
          <p>
        ...
        <div className={filtersty.hotel_wrapper}>
          {visibleData.map((hotedata, index) => (
            <Hoteinfotwo
              key={index}
              imgg={hotedata.imgg}
              btntxt={hotedata.btntxt}
              reviews={hotedata.reviews}
              contytittle={hotedata.contytittle}
              to={hotedata.to}
              addres={hotedata.addres}
              price={hotedata.price}
              filtersty={filtersty}
              hotedata={hotedata}
            />
          ))}
